...
const HOW_IT_WORKS: Record<KpiType, [string, string][]> = {
  clicks: [
    ['Get Your Link', 'Sign up and receive your unique ValueShare link instantly'],
  ...
  purchases: [
    ...
    ['Earn Your Reward', 'When your ValueShares lead to a purchase, you earn your reward'],
  ],
  shares: [
    ['Get Your Link', 'Sign up and receive your unique ValueShare link instantly'],
...
export const LANDING_TEMPLATES: LandingTemplateDefinition[] = [
  {
    ...
    defaults: {
      ...
      ctaText: 'Get My ValueShare Link \u2192',
      formPosition: 'bottom',
      tagline: '',
      videoUrl: '',
